...
async function deployGithubRepoToRailway(repo, projectName) {
  ...
  // with no deployment ever created. Fire it now, BEFORE asking Railway for
  // a domain: serviceDomainCreate needs Railway to already know what port
  // the service listens on, which it only detects once a build/deployment
  // exists. Calling it too early is what was producing "Problem processing
  // request".
